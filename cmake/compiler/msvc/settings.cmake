...
DisableIncrementalLinking(CMAKE_EXE_LINKER_FLAGS_RELEASE)
DisableIncrementalLinking(CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO)
DisableIncrementalLinking(CMAKE_SHARED_LINKER_FLAGS_DEBUG)
DisableIncrementalLinking(CMAKE_SHARED_LINKER_FLAGS_RELEASE)
DisableIncrementalLinking(CMAKE_SHARED_LINKER_FLAGS_RELWITHDEBINFO)

macro(EnableIncrementalLinking variable)
  string(REGEX REPLACE "/INCREMENTAL *" "" ${variable} "${${variable}}")
  set(${variable} "${${variable}} /INCREMENTAL:YES")
endmacro()

EnableIncrementalLinking(CMAKE_EXE_LINKER_FLAGS_DEBUG)
EnableIncrementalLinking(CMAKE_EXE_LINKER_FLAGS_RELEASE)
EnableIncrementalLinking(CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO)
EnableIncrementalLinking(CMAKE_SHARED_LINKER_FLAGS_DEBUG)
EnableIncrementalLinking(CMAKE_SHARED_LINKER_FLAGS_RELEASE)
EnableIncrementalLinking(CMAKE_SHARED_LINKER_FLAGS_RELWITHDEBINFO)
